...
def list_available_detail_fields() -> List[Dict[str, Any]]:
    ...
    fields = [
        ...
        {"name": "freecashflow", "description": "Free Cash Flow (ncfo minus capex)", "type": "BigInt"},
        {"name": "ebitdamargin", "description": "Ratio between EBITDA and revenue", "type": "Double"},
        ...
        {"name": "assetturnover", "description": "Revenue divided by average assets", "type": "Double"},
